...
import {
  CheckCircle, Code, Edit, Gift, Hand, Headset, Info, Lightbulb, Mail, Megaphone, Paintbrush, Puzzle, Rocket,
  ...
  ChevronDown, ArrowRight, HandIcon, Eye, Wrench, ShieldCheck, MailIcon, MapPin, Phone, Send, Linkedin, Twitter, Instagram, ArrowUp
} from 'lucide-react';
                ...
                <div className="container">
                    ...
                    <Tabs defaultValue="addons" className="mx-auto w-full max-w-5xl">
                        ...
                        <TabsContent value="ecommerce">
                             <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                <Card><CardHeader><div className="mb-4 flex justify-between items-start"><div className="flex h-12 w-12 items-center justify-center rounded-xl bg-green-50 dark:bg-green-900/30"><SmartphoneIcon className="h-6 w-6 text-green-600 dark:text-green-400"/></div><span className="text-xl font-bold text-foreground">₹499</span></div><CardTitle>UPI Integration</CardTitle><CardDescription>Accept payments via UPI for Indian customers.</CardDescription></CardHeader></Card>
                                <Card><CardHeader><div className="mb-4 flex justify-between items-start"><div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/30"><CreditCard className="h-6 w-6 text-blue-600 dark:text-blue-400"/></div><span className="text-xl font-bold text-foreground">₹999</span></div><CardTitle>International Payments</CardTitle><CardDescription>Stripe, PayPal & international gateway setup.</CardDescription></CardHeader></Card>
                                <Card><CardHeader><div className="mb-4 flex justify-between items-start"><div className="flex h-12 w-12 items-center justify-center rounded-xl bg-purple-50 dark:bg-purple-900/30"><Box className="h-6 w-6 text-purple-600 dark:text-purple-400"/></div><span className="text-xl font-bold text-foreground">₹99+</span></div><CardTitle>Product Listing</CardTitle><CardDescription>Add products with images, descriptions & pricing.</CardDescription></CardHeader></Card>
...
const WhatYouGet = () => (
    <section id="what-you-get" className="py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container">
            <div className="text-center mb-16">
                <Badge variant="secondary">What's Included</Badge>
                <h2 className="text-3xl md:text-5xl font-bold mt-6 mb-6">What You Get For FREE</h2>
