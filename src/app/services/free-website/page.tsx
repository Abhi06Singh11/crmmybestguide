...
export default function FreeWebsitePage() {
  ...
  const handleNextStep = async () => {
    ...
    switch (currentStep) {
      case 1:
        fieldsToValidate = ["fullName", "email", "phone", "businessName"];
        break;
      case 2:
        fieldsToValidate = ["websiteType"];
        break;
      case 4:
        fieldsToValidate = ["industry", "customIndustry"];
        break;
      case 5:
  ...
  const journeySteps = [
    {
      ...
      description:
        "Fill out a simple form with your business details and goals. Takes less than 2 minutes.",
      icon: Edit,
      label: "2 Min Application",
    },
    {
      step: 2,
      title: "Approval Confirmation",
      description:
        "Our team reviews your application within 24 hours. Approved? You'll get a welcome email!",
      icon: Mail,
    ...
    },
    {
      ...
      title: "Website Build",
      description:
        "Our designers and developers create your professional website in 7–10 business days.",
      icon: Code,
    ...
    },
    {
      ...
      description:
        "Review, approve, and launch your new website. You're officially online!",
      icon: Rocket,
      label: "Go Live!",
    },
  ];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 to-slate-900 py-20 text-white md:py-32">
        <div className="container relative z-10 text-center">
          <div className="mb-8 inline-flex animate-fade-in-up items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2 text-sm font-medium backdrop-blur-md">
            ...
            Limited-Time Offer – <span className="font-bold">7</span> Slots
            Remaining
          </div>
          <h1 className="mb-8 text-4xl font-black tracking-tight drop-shadow-sm md:text-6xl lg:text-7xl">
            Get a 100% FREE
            <br />
            Professional Website
          </h1>
          <p className="mx-auto mb-10 max-w-2xl text-lg text-blue-200 md:text-2xl">
            Launch your business online with a real, functional website.
            Generate leads, build trust, and grow –{" "}
            <strong>without spending a dime.</strong>
          </p>
          <div className="mb-12 flex flex-wrap justify-center gap-x-8 gap-y-4">
            <div className="flex items-center gap-2.5 rounded-lg border border-white/10 bg-white/5 px-4 py-2 font-medium text-white/90 backdrop-blur-sm">
          ...
          <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Button
              size="lg"
              className="w-full sm:w-auto animation-pulse-strong"
              onClick={() =>
                document
      ...
      <section id="features" className="py-24">
        <div className="container">
          <div className="mb-16 text-center">
            ...
            <h2 className="mt-6 mb-6 text-3xl font-bold md:text-5xl">
              What You Get For FREE
            </h2>
            <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
              Everything you need to establish your online presence – completely
              free of charge.
            </p>
          </div>
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 lg:gap-12">
            <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <CardHeader>
                ...
                <CardDescription>
                  Perfect for service businesses, professionals, and local
                  brands getting started online.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">
                  FREE E-Commerce Starter
                </CardTitle>
                <CardDescription>
                  Ideal for early-stage e-commerce brands and product sellers
                  ready to sell.
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <div className="container">
          <Card className="mx-auto max-w-5xl bg-gradient-to-br from-amber-50 to-orange-50 p-8 dark:from-slate-900 dark:to-slate-800 md:p-12">
            <div className="mb-10 flex items-start gap-5">
              <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-2xl border border-amber-200 bg-amber-100 shadow-sm dark:border-amber-500/20 dark:bg-amber-500/10">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 dark:text-gray-200">
                  We believe in honesty. Here's what the free version{" "}
            ...
            <div className="rounded-2xl border border-amber-200/50 bg-white/60 p-6 backdrop-blur-sm dark:border-amber-500/20 dark:bg-black/20">
              <div className="flex items-start gap-4 md:items-center">
                ...
                <p className="font-medium leading-relaxed text-gray-700 dark:text-gray-100">
                  <strong className="font-bold text-gray-900 dark:text-white">
                    The free version works perfectly
                  </strong>{" "}
                  for getting started. When you're ready to scale, growth
                  features are unlocked through affordable upgrades.
                </p>
              </div>
            </div>
          </Card>
      ...
      <section id="upgrades" className="py-24">
        <div className="container">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
              Unlock powerful growth tools as your business scales. No pressure
          ...
          <Tabs defaultValue="addons" className="mx-auto w-full max-w-5xl">
            ...
            <TabsContent value="addons">
              <p className="mb-8 text-center text-sm text-muted-foreground">
                ...
                Prices are starting prices — final cost depends on business
                needs.
              </p>
              <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 text-center dark:border-blue-800 dark:bg-blue-900/20 mb-8">
                <p className="font-bold leading-relaxed text-blue-950 dark:text-blue-500">
                  Domain and Hosting prices are not included. We offer a 10–15%
                  discount on GoDaddy hosting plans.
                </p>
              </div>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-900/30">
                      <FileText className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
                    </div>
                    <CardTitle>Extra Pages</CardTitle>
                    <CardDescription>
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-purple-50 dark:bg-purple-900/30">
                      <Paintbrush className="h-6 w-6 text-purple-600 dark:text-purple-400" />
                    </div>
                    <CardTitle>Custom UI/UX Design</CardTitle>
                    <CardDescription>
                      Tailored design per device & brand identity.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-green-50 dark:bg-green-900/30">
                      <Gauge className="h-6 w-6 text-green-600 dark:text-green-400" />
                    </div>
                    <CardTitle>Speed Optimization</CardTitle>
                    <CardDescription>
                      Performance tuning for lightning-fast load speeds.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 dark:bg-emerald-900/30">
                      <MessageCircleIcon className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />
                    </div>
                    <CardTitle>WhatsApp Integration</CardTitle>
                    <CardDescription>
                      Quick user engagement with direct WhatsApp chat button.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/30">
                      <Bot className="h-6 w-6 text-blue-600 dark:text-blue-400" />
                    </div>
                    <CardTitle>Chatbot Integration</CardTitle>
                    <CardDescription>
                      24/7 automated support based on AI model & tech stack.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-50 dark:bg-orange-900/30">
                      <CalendarCheck className="h-6 w-6 text-orange-600 dark:text-orange-400" />
                    </div>
                    <CardTitle>Booking System</CardTitle>
                    <CardDescription>
                      Online appointment scheduling based on complexity &
                      workflows.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <TabsContent value="support">
              <div className="grid items-start gap-8 md:grid-cols-3">
                <Card>
                  ...
                  <CardContent>
                    <p className="mb-6 min-h-[40px] text-sm text-muted-foreground">
                      Peace-of-mind support for small businesses.
                    </p>
                ...
                <Card className="relative z-10 scale-105 border-primary bg-primary text-primary-foreground">
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-amber-400 to-orange-500 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-white shadow-lg">
                    Most Popular
                  </div>
                  <CardHeader>
                    <div className="flex items-center gap-2">
                  ...
                  <CardContent>
                    <p className="mb-6 min-h-[40px] text-sm text-indigo-100">
                      For growing businesses ready to scale with priority
                      support.
                    </p>
                    <div className="mb-6 border-b border-white/20 pb-6">
                      <span className="text-4xl font-bold">{INR}1,499</span>
                      <span className="text-indigo-200">/month</span>
                    </div>
                    <ul className="mb-8 space-y-4 text-sm">
                      <li className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-green-400" />
                        30 Support Tickets/mo
                      </li>
                      <li className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-green-400" />
                        12-24 Hour Response
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="mb-6 min-h-[40px] text-sm text-muted-foreground">
                      Ideal for mission-critical websites & eCommerce.
                    </p>
                    <div className="mb-6 border-b pb-6">
                      <span className="text-4xl font-bold text-primary">
                        {INR}3,499
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Ranking, keyword & content optimization.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-red-50 dark:bg-red-900/30">
                ...
                <Card>
                  <CardHeader>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-pink-50 dark:bg-pink-900/30">
                      <Hash className="h-6 w-6 text-pink-600 dark:text-pink-400" />
                    </div>
                    <CardTitle>Social Media</CardTitle>
                    <CardDescription>
                      Content, posting & community growth.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardTitle>Funnels & Automation</CardTitle>
                    <CardDescription>
                      Lead flows, emails & conversion tracking.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-t pt-4">
                  ...
                  <CardHeader>
                    <div className="mb-4 flex justify-between items-start">
                      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-green-50 dark:bg-green-900/30">
                        <SmartphoneIcon className="h-6 w-6 text-green-600 dark:text-green-400" />
                      </div>
                      <span className="text-xl font-bold text-foreground">
                        {INR}499
                      </span>
                    </div>
                    <CardTitle>UPI Integration</CardTitle>
                    <CardDescription>
                      Accept payments via UPI for Indian customers.
                    </CardDescription>
                  </CardHeader>
                </Card>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Stripe, PayPal & international gateway setup.
                    </CardDescription>
                  </CardHeader>
                </Card>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Add products with images, descriptions & pricing.
                    </CardDescription>
                  </CardHeader>
                </Card>
                <Card>
                  <CardHeader>
                    <div className="mb-4 flex justify-between items-start">
                      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-orange-50 dark:bg-orange-900/30">
                        <Cog className="h-6 w-6 text-orange-600 dark:text-orange-400" />
                      </div>
                      <Badge>Custom</Badge>
                    </div>
                    <CardTitle>Store Automation</CardTitle>
                    <CardDescription>
                      Inventory management and order automation.
                    </CardDescription>
                  </CardHeader>
                </Card>
              </div>
            ...
            <TabsContent value="bundles">
              <div className="grid items-start gap-8 md:grid-cols-3">
                <Card>
                  <CardHeader>
                    <CardTitle>Startup Pack</CardTitle>
                  ...
                  <CardContent>
                    ...
                    <ul className="mb-8 space-y-3 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <Check className="h-5 w-5 text-green-500" />1 Month
                        Basic Support
                      </li>
                    </ul>
                    <Button variant="outline" className="w-full">
                ...
                <Card className="relative z-10 scale-105 border-primary bg-primary text-primary-foreground">
                  ...
                  <CardContent>
                    <div className="mb-6">
                      <span className="text-4xl font-bold">{INR}9,999</span>
                      <span className="ml-2 text-indigo-200 line-through">
                        {INR}15,999
                      </span>
                    </div>
                    <ul className="mb-8 space-y-3 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle className="h-5 w-5 text-green-400" />1
                        Month Growth Support
                      </li>
                    </ul>
                    <Button
                      variant="secondary"
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Complete growth solution</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="mb-6">
                      <span className="text-4xl font-bold text-primary">
                    ...
                    <ul className="mb-8 space-y-3 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <Check className="h-5 w-5 text-green-500" />3 Months
                        Support
                      </li>
                    </ul>
                    <Button variant="outline" className="w-full">
      ...
      <section id="journey" className="bg-secondary py-24">
        <div className="container">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
              From application to launch in 4 simple steps.
            </p>
          </div>
          <div className="relative mx-auto max-w-4xl">
            ...
            <div className="space-y-16">
              {journeySteps.map((item, index) => (
                ...
                >
                  <div
                    className={`md:w-1/2 ${index % 2 === 0 ? "md:text-right md:pr-12" : "md:order-3 md:text-left md:pl-12"}`}
                  >
                  ...
                  <div
                    className={`md:w-1/2 ${index % 2 === 0 ? "md:pl-12" : "md:order-1 md:text-right md:pr-12"}`}
                  >
      ...
      <section id="apply" className="py-24">
        <div className="container max-w-4xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
              No credit card required. No obligations. Just fill out the form
              below.
            </p>
          </div>
          <Card>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                      <h3 className="text-xl font-bold">
                        Select Add-Ons & Enhancements (Optional)
                      </h3>
                      <FormField
                        control={form.control}
                        name="addons"
                      ...
                      <div className="space-y-4 rounded-xl border bg-secondary p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <p>
                            ...
                            <span className="font-semibold">
                              {form.watch("industry") === "Custom"
                                ? form.watch("customIndustry")
                                : form.watch("industry") || "-"}
                            </span>
                          </p>
                        </div>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                            ...
                            <div className="space-y-1 leading-none">
                              <FormLabel>
                                I agree to the Terms of Service and understand I
                                will be redirected to WhatsApp to complete my
                                application.
                              </FormLabel>
                              <FormMessage />
                            </div>
