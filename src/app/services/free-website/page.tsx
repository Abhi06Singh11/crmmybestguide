...
=========================
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: `You'll receive hosting-ready code that you can deploy anywhere. We can help you set up affordable hosting (usually ${String.fromCharCode(8377)}300-1,000/month) or you can handle it yourself. Domain registration is also separate but we can guide you.`
        },
        {
            q: "Can I remove the agency branding?",
            a: `Yes! Footer branding removal is available as a one-time paid upgrade (${String.fromCharCode(8377)}999). This gives you a completely white-labeled website.`
        }
    ];

    const addonGroups = {
        'Performance & Design': [
            { icon: FileText, title: "Extra Pages", desc: "Add pages based on tech stack & requirements.", price: `${String.fromCharCode(8377)}499+` },
            { icon: Paintbrush, title: "Custom UI/UX Design", desc: "Tailored design per device & brand identity.", price: `${String.fromCharCode(8377)}999+` },
            { icon: Gauge, title: "Speed Optimization", desc: "Performance tuning for lightning-fast load speeds.", price: `${String.fromCharCode(8377)}899` },
            { icon: WhatsAppIcon, title: "WhatsApp Integration", desc: "Quick user engagement with direct WhatsApp chat.", price: `${String.fromCharCode(8377)}299` },
            { icon: Bot, title: "Chatbot Integration", desc: "24/7 automated support based on AI model & tech stack.", price: `${String.fromCharCode(8377)}999+` },
            { icon: CalendarCheck, title: "Booking System", desc: "Online appointment scheduling.", price: `${String.fromCharCode(8377)}1,499+` },
        ],
        'Support Plans': [
            { icon: Headset, title: 'Basic Support', desc: '5 tickets/mo, 48hr response.', price: `${String.fromCharCode(8377)}499/mo` },
            { icon: Headset, title: 'Growth Support', desc: '30 tickets/mo, priority response.', price: `${String.fromCharCode(8377)}1,499/mo` },
            { icon: Headset, title: 'Premium Support', desc: 'Dedicated engineer, 4hr SLA.', price: `${String.fromCharCode(8377)}3,499/mo` },
        ],
        'Marketing & Growth': [
            { icon: Search, title: 'SEO Services', desc: 'Ranking, keyword & content optimization.', price: `${String.fromCharCode(8377)}1,999+/mo` },
            { icon: LineChart, title: 'Google Ads', desc: 'Campaign setup & ongoing optimization.', price: `${String.fromCharCode(8377)}1,499+/mo` },
            { icon: Hash, title: 'Social Media', desc: 'Content, posting & community growth.', price: `${String.fromCharCode(8377)}1,999+/mo` },
            { icon: Filter, title: 'Funnels & Automation', desc: 'Lead flows & conversion tracking.', price: `${String.fromCharCode(8377)}1,999+ one-time` },
        ],
        'E-Commerce & Payments': [
            { icon: CreditCard, title: 'UPI Integration', desc: 'Accept payments via UPI for Indian customers.', price: `${String.fromCharCode(8377)}499` },
            { icon: CreditCard, title: 'International Payments', desc: 'Stripe, PayPal & international gateway setup.', price: `${String.fromCharCode(8377)}999` },
            { icon: Box, title: 'Product Listing', desc: 'Add products with images, descriptions & pricing.', price: `${String.fromCharCode(8377)}99+` },
            { icon: Settings, title: 'Store Automation', desc: 'Inventory management and order automation.', price: 'Custom' },
        ],
        'Value Bundles': [
            { icon: Gift, title: 'Startup Pack', desc: '5-page site, design & speed.', price: `${String.fromCharCode(8377)}4,999` },
            { icon: Gift, title: 'Growth Pack', desc: '10-page, booking, SEO.', price: `${String.fromCharCode(8377)}9,999` },
            { icon: Gift, title: 'Accelerator Bundle', desc: 'Full custom site & growth.', price: `${String.fromCharCode(8377)}19,999` },
        ],
    };
                         ...
                         <Card className="p-8 md:p-10 relative overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-primary text-card-foreground hover:text-primary-foreground">
                           <CardHeader>
                             ...
                             <CardContent>
                                ...
                                <div className="pt-6 border-t relative z-10 group-hover:border-primary-foreground/30">
                                    <div className="flex items-center justify-between">
                                        <div className="flex flex-col"><span className="text-sm text-muted-foreground mb-1 group-hover:text-primary-foreground/80">Estimated Value</span><div className="flex items-baseline gap-2"><span className="text-3xl font-bold text-foreground group-hover:text-primary-foreground">{String.fromCharCode(8377)}0</span><span className="text-muted-foreground line-through text-lg group-hover:text-primary-foreground/60">{String.fromCharCode(8377)}24,999</span></div></div>
                         ...
                         <TabsContent value="support">
                            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
                                <Card className="p-8 group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-primary text-card-foreground hover:text-primary-foreground">
                                    ...
                                    <div className="mb-6 pb-6 border-b group-hover:border-primary-foreground/30"><span className="text-4xl font-bold text-primary group-hover:text-white">{String.fromCharCode(8377)}499</span><span className="text-muted-foreground group-hover:text-primary-foreground/80">/mo</span></div>
                                ...
                                <Card className="p-8 border-2 border-primary shadow-2xl shadow-primary/20 scale-105 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                                    ...
                                    <div className="mb-6 pb-6 border-b"><span className="text-4xl font-bold text-primary">{String.fromCharCode(8377)}1,499</span><span className="text-muted-foreground">/mo</span></div>
                                    <ul className="space-y-4 mb-8">
                                ...
                                <Card className="p-8 group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-primary text-card-foreground hover:text-primary-foreground">
                                    ...
                                    <div className="mb-6 pb-6 border-b group-hover:border-primary-foreground/30"><span className="text-4xl font-bold text-primary group-hover:text-white">{String.fromCharCode(8377)}3,499</span><span className="text-muted-foreground group-hover:text-primary-foreground/80">/mo</span></div>
                                    <ul className="space-y-4 mb-8">
