...
export default function ProjectDetailsPage() {
  ...
  const project = availableNetworkProjectsData.find(p => p.id === id);
  ...
  if (!project) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <Button onClick={() => router.push('/d/network/upcoming-projects')} className="mt-4">
    ...
    <div className="space-y-8">
      <div>
        <Button
          variant="outline"
          className="mb-4"
          onClick={() => router.push('/d/network/upcoming-projects')}
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to Upcoming Projects
        </Button>
                ...
                <FormField control={form.control} name="proposal" render={({ field }) => (
                 ...
                 <FormField control={form.control} name="portfolioLink" render={({ field }) => (
                    ...
                    <FormControl>
                     ...
                     <FormDescription>Optional. Link to your LinkedIn or personal website.</FormDescription>
                    <FormMessage />
                    </FormItem>
                )} />
                <FormField control={form.control} name="additionalSkills" render={({ field }) => (
                    <FormItem>
                    <FormLabel>Additional Certifications or Expertise</FormLabel>
                    <FormControl>
                        <Textarea placeholder="List any other relevant certifications or expertise." {...field} />
                    </FormControl>
