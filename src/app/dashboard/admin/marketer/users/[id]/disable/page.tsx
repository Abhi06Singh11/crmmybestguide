...
export default function DisableMarketerUserPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Button variant="outline" onClick={() => router.push('/d/admin/marketer/users')}>
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to Users
        </Button>
      </div>
      <Card className="max-w-xl mx-auto">
        ...
        <CardFooter className="flex justify-end gap-2 pt-6">
            <Button variant="outline" onClick={() => router.push('/d/admin/marketer/users')}>Cancel</Button>
