...
export default function AssignTeamPage() {
  ...
  const handleAssign = (devName: string) => {
      toast({
          title: "Developer Assigned",
          description: `${devName} has been assigned to "New Website Launch".`,
      });
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
            <CardHeader>
                <CardTitle>Assign Team for "New Website Launch"</CardTitle>
                <CardDescription>Find and assign the right talent to this project.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col md:flex-row gap-4 border-t pt-4">
                ...
                <Card key={dev.id} className="flex flex-col">
                    ...
                    <CardContent className="flex flex-col flex-grow">
                        ...
                        <div className="mt-auto flex gap-2">
                           ...
                           <Button className="w-full" onClick={() => handleAssign(dev.name)}>Assign</Button>
                        </div>
                    </CardContent>
                </Card>
            ))}
