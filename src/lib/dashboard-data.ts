...
export const marketerKpiData = [
  { title: 'Lifetime Earnings', value: '₹10,034,400', change: '+15% this year', changeType: 'increase', icon: DollarSign },
  { title: 'Earnings This Month', value: '₹1,218,480', change: '+20.1% vs last month', changeType: 'increase', icon: Calendar },
  { title: 'Pending Payments', value: '₹660,000', change: '3 invoices', changeType: 'increase', icon: Hourglass },
...
export const clientsData = [
  { 
    ...
    associatedProjects: [
        { name: 'Q3 Marketing Campaign', status: 'Active', value: '₹1,200,000' },
        { name: 'App Backend API', status: 'Completed', value: '₹2,000,000' }
    ]
  },
  { 
    id: 'cli-ii',
    ...
    associatedProjects: [
        { name: 'New Website Launch', status: 'Active', value: '₹2,400,000' }
    ]
  },
  { 
    id: 'cli-sc',
    ...
    associatedProjects: [
        { name: 'SEO Optimization', status: 'Completed', value: '₹960,000' }
    ]
  },
  { 
    id: 'cli-ff',
    ...
    notes: 'New client in the AI space. Potentially large projects on the horizon.',
     associatedProjects: [
        { name: 'Social Media Strategy', status: 'On Hold', value: '₹640,000' }
    ]
  },
  { 
    id: 'cli-ng',
  ...
  { 
    ...
    notes: 'Payment for the last milestone is overdue by 15 days. Follow up required.',
     associatedProjects: [
        { name: 'Mobile App Revamp', status: 'Risk', value: '₹1,760,000' }
    ]
  },
];
...
export const earningsData = {
    tableData: [
        { id: 1, project: 'Q3 Marketing Campaign', client: 'Quantum Solutions', amount: 200000, status: 'Paid', date: '2024-07-28', invoiceId: 'INV-0728' },
        { id: 2, project: 'New Website Launch', client: 'Innovate Inc.', amount: 400000, status: 'Approved', date: '2024-08-15', invoiceId: 'INV-0815' },
        { id: 3, project: 'Social Media Strategy', client: 'Future Forward', amount: 144000, status: 'Pending', date: '2024-08-20', invoiceId: 'INV-0820' },
        { id: 4, project: 'SEO Optimization', client: 'Starlight Co.', amount: 260000, status: 'Pending', date: '2024-08-10', invoiceId: 'INV-0810' },
        { id: 5, project: 'App Backend API', client: 'Quantum Solutions', amount: 360000, status: 'Paid', date: '2024-07-15', invoiceId: 'INV-0715' },
    ],
    earningsChartData: [
        { date: 'Jan 24', earnings: 320000 }, { date: 'Feb 24', earnings: 240000 }, { date: 'Mar 24', earnings: 400000 },
        { date: 'Apr 24', earnings: 360000 }, { date: 'May 24', earnings: 480000 }, { date: 'Jun 24', earnings: 600000 }, { date: 'Jul 24', earnings: 656000 },
    ],
